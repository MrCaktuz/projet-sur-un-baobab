...
?>
    ...
    <aside class="sideNav">
        <h2 class="sideNav__titles">Nos articles</h2>
        <ol class="sideNav__list">
            <?php
                $posts = new WP_QUERY( [ 'category_name' => 'non-classe-fr' ] );
    ...
    <div class="bigWrap">
        <h2 class="archives__title">Nos articles</h2>
        <?php
            $posts = new WP_QUERY( [ 'post_type' => 'post', 'category_name' => 'non-classe-fr' ] );
            if ( $posts -> have_posts() ): while ( $posts -> have_posts() ): $posts -> the_post();
        ?>
            <articles>
                <div class="wrap">
